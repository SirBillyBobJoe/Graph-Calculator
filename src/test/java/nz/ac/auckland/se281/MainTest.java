...
public class MainTest {
  ...
  public static class YourTests extends CliTest {
    ...
    @Test
    public void TY_02X_test_one_RBFS() throws Exception {
      runCommands(OPEN_FILE, "test3.txt", GRAPH_SEARCH_IBFS);
      assertContains("Successfully opened graph from file test3.txt");
      assertContains(
          "[1, 2, 3, 4, 5, 10, 6, 7, 9, 8, 11, 15, 22, 29, 16, 23, 30, 13, 20, 27, 12, 19, 26, 14,"
    ...
    @Test
    public void TY_03X_test_one_IDFS() throws Exception {
    ...
    @Test
    public void TY_04X_test_one_RDFS() throws Exception {
      runCommands(OPEN_FILE, "test3.txt", GRAPH_SEARCH_IDFS);
      assertContains("Successfully opened graph from file test3.txt");
      assertContains(
          "[1, 2, 5, 15, 22, 29, 10, 16, 23, 30, 3, 6, 13, 20, 27, 7, 12, 19, 26, 9, 14, 21, 28, 4,"
    ...
    @Test
    public void TY_01X_test_one_IBFS() throws Exception {
